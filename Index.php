...
<table width="95%" border="1" align="center" bordercolor="#001a33">
  <tr>
    <td height="144" valign="top" bgcolor="#001a33" align="center"><p class="style1">House Rent Management System</p>
...
<table width="95%" border="0" align="center" bordercolor="#1a0000">
  <tr>
    ...
    <td width="19%" bgcolor="#FF8C00"><div align="center"><strong><a href="guest.php">Guest</a></strong></div></td>
    <td width="15%" bgcolor="#FF8C00"><div align="center"><strong><a href="user.php">User</a></strong></div></td>
    <td width="27%" bgcolor="#FF8C00"><div align="center"><strong><a href="about.php">About Us</a></strong></div></td>
  </tr>
</table>
  <p>&nbsp;</p>
    ...
    <tr>
      <td align="center"><p><span class="style3"><strong>House Rental</strong>:</span></p>
        <table width="90%" border="0" align="center">
          <tr>
            <td>&nbsp;&nbsp;
           <img src="images\1.jpg" width="1340" height="400"/>
          </tr>
        </table>
      <p>&nbsp; </p></td>
    </tr>
